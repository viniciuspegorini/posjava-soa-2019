...
public class JwtUsernameAndPasswordAuthenticationFilter 
	...
	public Authentication attemptAuthentication(
		...
		try {
			...
			// 1. Pega as credenciais do request
			UserCredentials creds = new ObjectMapper().readValue(
			...
			// 3. AuthenticationManager autentica o usuário e utiliza o 
			// UserDetialsServiceImpl::loadUserByUsername() para carregar o usuário.
	...
	// Caso a autenticação ocorra com sucesso, gera o token.
	@Override
